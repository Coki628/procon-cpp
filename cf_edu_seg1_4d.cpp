 ...
 * ・区間の異なる数の個数
 * ・わりとさくっと自力AC！
 * ・さっきの転倒数のやつと方針はだいたい同じ。要素の種類数が40しかないのでそこを突く。
 * ・各区間について、重複した数の方を持っておけばやりやすいと思った。
 * 　回答クエリでは、区間長 - 重複した数 が答え。
 */
...
// その区間が持つ重複した数と、どの値を持っているかの集合を管理する
struct Node {
